...
- Create Angular project with ng: `ng new NetCoreAngularApp.Template.Client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`NetCoreAngularApp.Template.Client.esproj`).
